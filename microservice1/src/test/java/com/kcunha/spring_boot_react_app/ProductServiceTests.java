...
public class ProductServiceTests {
    ...
    public void testGetProductById() {
        ...
        // Mock RestTemplate call to Inventory Service with the correct URL
        InventoryResponse mockInventoryResponse = new InventoryResponse(1L, 50);
        when(restTemplate.getForObject("microservice2/1", InventoryResponse.class))
        ...
        verify(restTemplate, times(1)).getForObject("microservice2/1", InventoryResponse.class);
    }    
