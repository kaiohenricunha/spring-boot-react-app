...
public class ProductController {
    ...
    // Ensure List<String> has the correct generic type
    private static final List<String> VALID_SORT_FIELDS = Arrays.asList("name", "price", "id", "description");
    ...
    public Page<Product> getAllProducts(
        ...
        if (!VALID_SORT_FIELDS.contains(sortBy)) {
            sortBy = "name";  // Default to sorting by name if invalid field is provided
        }
    ...
    public Page<ProductHistory> getProductHistory(
        ...
        // Validate the sortBy field for history
        if (!Arrays.asList("modifiedDate", "price", "name").contains(sortBy)) {
            sortBy = "modifiedDate";  // Default to sorting by modifiedDate if invalid field is provided
        }
